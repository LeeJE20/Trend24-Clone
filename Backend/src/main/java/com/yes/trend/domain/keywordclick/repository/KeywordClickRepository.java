...
public interface KeywordClickRepository extends JpaRepository<KeywordClick, Integer> {
	Optional<KeywordClick> findByKeywordNameAndCategory_IdAndCreatedTimeBetween(String keywordName, Byte CategoryId, LocalDateTime startDate, LocalDateTime endDate);
}
